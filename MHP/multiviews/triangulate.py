...
def build_multi_camera_system(cameras):
    ...
    # print('pymvg_cameras: ', pymvg_cameras)
...
def triangulate_poses(camera_params, poses2d, confs=None, conf_threshold=0.85):
    """
