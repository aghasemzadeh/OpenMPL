...
class MultiView_CMU_Panoptic_H36M_MPL(JointsDataset_MPL):
    ...
    def __init__(self, cfg, image_set, is_train, transform=None):
        ...
        self.grouping = self.get_group_cmu(self.db)
    ...
    def __getitem__(self, idx):
        ...
        joints_3d = copy.deepcopy(self.db[item]['joints_3d'])
        pose_3d = joints_3d / 100 # convert to meters
